...
ALWAYS_AVAILABLE = frozenset({
    ...
    "update_plan",
    # CKB work must load authoritative local instructions before acting.
    "ckb_preflight",
})
...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "ckb_preflight": "Read the binding CKB root instructions, root index, target-path AGENTS.md chain, and relevant Lessons Learned files before non-trivial CKB work. Pass the task and exact CKB target paths. This tool is read-only and records successful preflight for the current chat.",
